"""
train_v3_greyscale.py

Greyscale variant of train_v3.py.
The only differences are that DATA_DIR points to data/images_greyscale/
and outputs are saved to data/models/greyscale/v3/.

V3 improvements over V2:
  - CosineAnnealingLR (no restarts) — warm restarts destabilised V2 convergence
  - Label smoothing reduced 0.1 -> 0.05
  ...
  - GPU-optimised dataloading: batch_size=512, num_workers=8, pin_memory,
    persistent_workers, prefetch_factor (required on this machine)
"""
...
MODEL_DIR    = ROOT / "data" / "models" / "greyscale" / "v3"
...
# ---------------------------------------------------------------------------
# CNN Architecture  (identical to V1/V2/V3)
# ---------------------------------------------------------------------------
